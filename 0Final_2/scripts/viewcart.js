...
function appendData(cartLS) {
    ...
    document.getElementById("totalAmt").innerText = Total_payable;
    obj.beforeGST=Total_payable;
    let gst=Gst(cartLS);
    document.getElementById("GSTAmt").innerText=gst;
    obj.GSTamt=gst;
    let finalValue=Total_payable+gst;
    document.getElementById("overallTotal").innerText=finalValue;
    localStorage.setItem("final_sum",finalValue);
    obj.finalAmt=finalValue;
    console.log(obj);
    localStorage.setItem("finalValue",JSON.stringify(obj));
