function footer(){
    ...
    <div id="f2">
        ...
        <div id="f2d">
            ...
            <a class="fa" href="ship&return.html"><p class="fpp" class="fp">Shipping & Returns</p></a>
            <a class="fa" href="privacypolce.html"><p class="fpp" class="fp">Privacy Policy </p></a>
            <a class="fa" href="t&c.html"><p class="fpp" class="fp"> Terms & Conditions</p></a>
        </div>
        <div id="f2e">
